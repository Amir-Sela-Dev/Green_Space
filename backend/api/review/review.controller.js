...
async function addReview(req, res) {
    ...
    try {
        ...
        review.aboutPlant = await plantService.getById(review.aboutPlantId)
        ...
        socketService.emitToUser({ type: 'review-about-you', data: review, userId: review.aboutPlant._id })
